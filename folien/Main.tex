...
\begin{itemize}
	...
	\begin{itemize}[<+->]
		...
		\item '-r'  (reversiv) umgekehrte Reihenfolge
...
\hline
\textbf{\textcolor{ownDarkOr}{'-E'}} & erweiterter RegEx \\
\hline
\textbf{\textcolor{ownDarkOr}{'-F'}} & fixed String\\
\hline 
\textbf{\textcolor{ownDarkOr}{'-G'}} & basic RegEx\\

\end{tabular} \\ \\
\begin{tabular}{l|c}
& {\scriptsize \textbf{Ausgabe}}\\
\hline
\textbf{\textcolor{ownDarkOr}{'-c'}} & Anzahl passender Zeilen\\
\hline
\textbf{\textcolor{ownDarkOr}{'-o'}} & nur gematchte Teile einer Zeile\\
\hline
\textbf{\textcolor{ownDarkOr}{'-q'}} & keine Ausgabe, nur Exitcode  \\
& (0 wenn erfolgreich)\\
\end{tabular}
&
\begin{tabular}{l|c}
...
\hline
\textbf{\textcolor{ownDarkOr}{'-f [file]'}} & liest RegEx aus [file]\\
\hline
\textbf{\textcolor{ownDarkOr}{'-v'}} & invertiert Matchmaking\\
\hline
\textbf{\textcolor{ownDarkOr}{'-w'}} & nur Zeilen, in denen ganze\\
& Worte RegEx entsprechen\\ 
\hline
\textbf{\textcolor{ownDarkOr}{'-x'}} & nur Zeilen, die ganz \\
